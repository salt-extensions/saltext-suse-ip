# Salt Extension for Suse Ip

Salt Extension for interacting with SUSE IP module
...
The saltext-suse-ip project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-suse-ip.git
...
* Writing blog posts
* Sharing your experiences using Salt + Suse Ip
  on social media
...
[PRs]: https://github.com/salt-extensions/saltext-suse-ip/pulls
[discussions]: https://github.com/salt-extensions/saltext-suse-ip/discussions
